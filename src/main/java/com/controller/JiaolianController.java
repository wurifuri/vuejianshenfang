...
public class JiaolianController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiaolianEntity u = jiaolianService.selectOne(new EntityWrapper<JiaolianEntity>().eq("jiaolianzhanghao", username));
    ...
    public R register(@RequestBody JiaolianEntity jiaolian){
    	...
    	JiaolianEntity u = jiaolianService.selectOne(new EntityWrapper<JiaolianEntity>().eq("jiaolianzhanghao", jiaolian.getJiaolianzhanghao()));
		if(u!=null) {
