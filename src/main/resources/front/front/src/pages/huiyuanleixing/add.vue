...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="会员卡类型" prop="huiyuankaleixing">
            <el-select v-model="ruleForm.huiyuankaleixing" placeholder="请选择会员卡类型"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="详情" prop="xiangqing">
            <el-input v-model="ruleForm.xiangqing" 
                placeholder="详情" clearable ></el-input>
          </el-form-item>
