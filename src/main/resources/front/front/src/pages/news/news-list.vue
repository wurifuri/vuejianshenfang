...
<div>
	...
	<div class="news-preview" :style='{"border":"2px solid #FFB74D","padding":"20px","margin":"20px auto 0 auto","borderRadius":"8px","background":"rgba(255,255,255,1)","width":"1200px","position":"relative","height":"auto"}'>
				
				
				<!-- 样式三 -->
		<div class="list3 index-pv1" :style='{"width":"100%","margin":"0 0 20px","background":"none","height":"auto"}'>
			<div :style='{"cursor":"pointer","padding":"20px","margin":"0px 0","borderColor":"#FFB74D","background":"none","borderWidth":"0 0 1px 0","width":"100%","position":"relative","borderStyle":"solid","height":"auto"}' v-for="item in newsList" :key="item.id" @click="toNewsDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"12px","color":"#fff","borderRadius":"12px","textAlign":"center","background":"radial-gradient(circle, rgba(255,183,77,1) 0%, rgba(255,77,77,1) 100%)","bottom":"10px","display":"inline-block","width":"40px","fontSize":"14px","lineHeight":"1.1","position":"absolute","height":"80px"}' class="tags ">新闻动态</div>
			</div>
		</div>
